...
class Estrutura:
    ...
    def shape_fun(self, F_flexao1, F_flexao2, F_axial,F_torcao): 
        ...
        I = 1.6667e-5 	#Momento de inercia (m^4)
        G = 81.2e9  	#Modulo de Cisalhamento (Pa)
        A= 0.0005	    #Área da seção do elemento (m^2)	
        J = I/2     	#Momento polar de inércia (m^4)
        KF_total = 0
        KT_total = 0
        KF_elements = []
...
F_global[0+14*6] = 5000
fixed_dofs = [9*6,9*6+1,9*6+2,9*6+3,9*6+4,9*6+5,8*6,8*6+1,8*6+2,8*6+3,8*6+4,8*6+5,27*6,27*6+1,27*6+2,27*6+3,27*6+4,27*6+5,26*6,26*6+1,26*6+2,26*6+3,26*6+4,26*6+5]
