...
#print(x)
cm_estrutura, m_estrutura = estrutura.calcular_centro_de_massa()
print("Centro de massa da estrutura:")
print(f"  X = {cm_estrutura[0]:.4f} m")
print(f"  Y = {cm_estrutura[1]:.4f} m")
print(f"  Z = {cm_estrutura[2]:.4f} m")

print(f"Massa da estrutura [kg]: {m_estrutura:.2f}")
...
massas_extra = [
    {'massa': 85.0, 'posicao': [1.2, 0.5, 0.6]},   # piloto
    {'massa': 42.0, 'posicao': [1.0, 0.0, 0.4]},   # motor
    {'massa': 18.0, 'posicao': [0.6, -0.3, 0.3]}   # bateria
]

cm_total, m_total = estrutura.adicionar_massas_concentradas(
    cm_estrutura,
    m_estrutura,
    massas_extra
)
...
print(f"X = {cm_total[0]:.4f} m")
print(f"Y = {cm_total[1]:.4f} m")
print(f"Z = {cm_total[2]:.4f} m")
print(f"Massa total = {m_total:.2f} kg")
