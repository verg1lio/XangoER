...
class Motor2:
    ...
    def get_torque():
        motor = Motor2()
        return motor.torque_continuo_interp[:] 
...
class Drivetrain:
    ...
    def Reduções(self, eficiencia_corrente=0.96):
        ...
        torque_motor = Motor2.get_torque()
        potencia_motor = Motor2.get_potencia()
    ...
    def CarPerformance(self):
        ...
        potencia_reduzida = expandir(potencia_reduzida_raw)
...
class Tire:
    ...
    def SlipRatio(velocidade_angular, raio_pneu, velocidade_linear):
            ...
            value = (1 -(velocidade_angular * raio_pneu / velocidade_linear)) 
            return value
