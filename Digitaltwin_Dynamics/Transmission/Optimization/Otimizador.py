...
def simulation(i_ratio, distancia_desejada):
    ...
    try:
        ...
        with contextlib.redirect_stdout(log_capture):
            ...
            transmission = Transmission.Transmission(final_drive_ratio=float(i_ratio), axle_inertia=0.0015, diff_inertia= 0.012, efficiency=0.95)
            vehicle = Vehicle.Vehicle(mass=240.0, wheel_radius=0.275,wheel_mass=5.0, drag_coeff=0.7789,
                                      frontal_area=0.68, rolling_resistance=0.015, road_grade=0.0,L= 1.5, h = 0.28, dist_cg= 0.6)
