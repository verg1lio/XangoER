...
# ---------------------
    ...
    def funcoes_de_forma(self, xi, L, alpha, beta):
        ...
        """
        # Funções H
        # Condições de contorno: H1(0) = 1, H2(1) = 1, H3(0) = 0 e H4(1) = 0.
...
# B) Aplicação de Cargas
# Fórmula genérica: Nó*GDLs + [0, 1, 2, 3, 4, 5] para [x, y, z, rx, ry, rz]

# Força em X no P2 (Nó 1 no Python, GDLs 6,7,8,9,10,11)
F[6*1 + 0] = 1000.0  # Fx no Nó 2

# Força em Z no P3 (Nó 2 no Python, GDLs 12,13,14,15,16,17)
F[6*2 + 2] = 500.0  # Fz no Nó 3
