...
def penalidades_geometricas(nodes, elements):
    ...
    """ 
    """       
        # Aplicação de penalidade de retidão vertical exemplo
    pen_elemento1 =  penalidade_retidão_vertical (nodes, no1, no2)
    """

        # Aplicação de penalidade de retidão vertical Front Bulkhead
    pen_retidão_vertical_fb = penalidade_retidão_vertical (nodes, 0, 1)

        # Aplicação de penalidade de retidão vertical Rear Bulkhead
    pen_retidão_vertical_rb = penalidade_retidão_vertical (nodes, 12, 13)
    ...
    penalidade += pen_retidão_vertical_fb
    penalidade += pen_retidão_vertical_rb
    return penalidade
